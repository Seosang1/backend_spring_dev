...
function showUid() {
	...
	var ucode = "${user.u_code }";
	
	if(ucode == "C") {
		document.getElementById("u_id").value = "관리자";
		$("#uidBox").prop('readonly', true);
		console.log("userId isNull" + uid);
		$("#reply_contents").prop('readonly', true);
		$("#reply_contents").text("관리자만 작성 가능합니다");
		console.log("ucode : " + ucode);
	} else {
		console.log("관리자 로그인 성공 admin ID : " + uid);
		console.log("ucode : " + ucode); 
	}
} 
	...
	<div class="my-3 p-3 bg-white rounded shadow-sm" style="padding-top: 10px">
		<form:form name="form" id="form" role="form" modelAttribute="boardDto"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<form:input path="u_id" class="form-control" id="u_id" value="<%= uid%>" ></form:input>
