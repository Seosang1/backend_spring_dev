...
function viewDetail(seq, u_id){
	...
	if (uid != u_id || uid == "null") {
		...
		console.log("성공" + "uid : " + uid + "u_id : " + u_id); 
		location.href = url;
	}
}
					...
					<c:when test="${!empty boardList}">
						<c:forEach var="list" items="${boardList}">
							<tr>
								...
								<td><a href="#"
									onclick="viewDetail(<c:out value="${list.seq}"/>, '<c:out value="${list.u_id}"/>' )"><c:out value="${list.title}" /></a></td>
	...
	<div id="paginationBox">
		<ul class="pagination">
			<c:if test="${pagination.prev}">
				<li class="page-item">
					<a class="page-link" href="#" onClick="fn_prev('${pagination.page}', '${pagination.range}', '${pagination.rangeSize}', '${search.searchType }', '${search.keyword }' )"></a>
			</c:if>
			...
			<c:if test="${pagination.next}">
				<li class="page-item">
					<a class="page-link" href="#"	onClick="fn_next('${pagination.page}', '${pagination.range}', '${pagination.rangeSize}', '${search.searchType }', '${search.keyword }')">Next</a></li>
			</c:if>
		</ul>
	</div>
	<!-- pagination{e} -->
