				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="container text mt-5 ms-5">
							...
							<c:if
								test="${sessionScope.u_id != null and sessionScope.u_id != dto.u_id}">
								<button class="btn btn-outline-success btn-lg"
								style="color: gray; width: 150px;" id="btnRecommend">좋아요</button>
							</c:if>
							&nbsp;&nbsp;
						</div>
				 ...
				 -->
					...
					<div class="text-center" id="detail">
						...
						<img class="mt-5" src="/images/product/a.jpg"
							style="width: 1000px; height: 700px;"> <br> <br>
						<br> <br>

						<div class="container text-center fs-1">
							<span> 상품 이름: ${dto.title } </span> <br> <span> 상품
								가격: ${dto.price }</span> <br> <span> 상품 설명:${dto.contents}</span>
							<br> <br> <br> <br> <br>
