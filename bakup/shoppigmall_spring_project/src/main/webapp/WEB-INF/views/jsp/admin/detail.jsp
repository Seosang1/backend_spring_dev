...
<div class="container-fluid text-center">    
  ...
  <form:form commandName="productDto" method="POST" action="/admin/ad_Modify/${ productDto.seq }" id="product_register_form"  enctype="multipart/form-data" >

<div>
		<table id=basic-info border="1">
			<div class="mb-4 row">
				<label for="board_subject" class="col-sm-2 col-form-label">카테고리</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="category " name="category"  maxlength="20" value="${ productDto.category }">
				</div>
			</div><br>
			<div class="mb-4 row">
				<label for="board_subject" class="col-sm-2 col-form-label">상품 제목</label>
				<div class="col-sm-5">
					<input type="hidden" name="seq" value="${ productDto.seq }">
					<input type="text" class="form-control" id="title " name="title"  maxlength="20" value="${ productDto.title }">
				</div>
			</div><br>
			<div class="mb-4 row">
				<label for="board_subject" class="col-sm-2 col-form-label">상품 수정자</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="writer " name="writer"  maxlength="20" value="${ productDto.writer }" readonly="true">
				</div>
			</div><br>
			<div class="mb-3 row">
				<label for="board_price " class="col-sm-2 col-form-label">상품 가격</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="price " name="price " maxlength="40" value="${ productDto.price }">	
				</div>
			</div><br>
			<div class="mb-3 row">
				...
				<div class="col-sm-5">
					<div class="form-floating">
					  	<textarea class="form-control" name="contents" style="height: 200px">${ productDto.contents }</textarea>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-5">
					<input type="hidden" name="photo" value="${ productDto.photo }">
					<img id="photo " name="photo" src="/images/product/${ productDto.photo }">	
				</div>
			</div><br>
			<div class="mb-3 row">
		...
		<button type="button" onclick="delete_product(${ productDto.seq })" class="w3-button w3-block w3-black w3-ripple w3-margin-top w3-round">삭제</button>
