...
<%--      <a href="main"><img alt="메인" src="${path}/images/kjh/logo.png">AT-TONG</a> --%>
    ...
    <div class="collapse navbar-collapse dropmenu" id="myNavbar">
      ...
      <ul class="nav navbar-nav col-sm-6 big">
      	<li><a href="../adMember.do">회원관리</a></li>
        <li><a>상품관리</a>
        
        	<ul class="menu_shop">
        		<li><a href="../adProductList.do">상품리스트</a></li>
        ...
        <li><a>게시판관리</a>
        	...
        	<ul class="menu_shop">
        		<li><a href="../admin/operator_main">admin page</a></li>
        		<li><a href="../admin/operator_main_paging">admin paging</a></li>
        		<li><a href="../admin/operator_main_paging_search">admin paging search</a></li>
          	</ul>
        </li>
        <li><a href="#">댓글관리</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right col-sm-3">
        ...
        <li><a href="../admin/operator_main_paging" id="aaa"><i class="far fa-user">관리자 모드</i></a></li>
